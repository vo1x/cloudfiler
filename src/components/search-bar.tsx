...
export const Searchbar = () => {
  ...
  return (
    <div className="flex flex-col gap-2 border w-max border-neutral-800 rounded-md">
      <div
        className={`flex items-center text-neutral-400 px-2 gap-1 h-max rounded-lg bg-neutral-900 w-[32rem]`}
      >
